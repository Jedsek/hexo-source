...
2. Sep 是有限制的, [p3#歧义限制](/posts/rust-decl-macro/p3#qi-yi-xian-zhi) 提到过, 详情可见 [rust-reference](https://doc.rust-lang.org/stable/reference/macros-by-example.html#follow-set-ambiguity-restrictions)
